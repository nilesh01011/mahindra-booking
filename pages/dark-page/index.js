    ...
    return (
        <>
            ...
            <div className='w-full h-full'>
                {/* banners */}
                <div className='w-full h-[100vh - 70px]'>
                ...
                <div className='max-w-[1200px] mx-auto xl:px-0 px-[15px]'>
                    <div className='w-full h-full md:py-[40px] py-[20px]'>
                        ...
                        <div className='w-full'>
                            <h2 className='pl-[15px] text-white uppercase text-[18px] font-bold relative before:content-[""] before:absolute before:left-0 before:top-[6%] before:w-[2px] before:h-[80%] before:bg-[#ce0e2d]'>
                                explore xuv700
                        ...
                        <div className='w-full md:mt-[30px] flex lg:flex-row flex-col gap-[20px] items-center py-[20px]'>
                            ...
                            <div className='lg:w-1/2'>
                                <div className='lg:w-[90%]'>
                                    <h2 className='md:text-[36px] text-[24px] text-white font-black'>Here is where the impossible begins</h2>
                                    <p className='md:text-[18px] text-[14px] text-white sm:mt-[15px] mt-[10px]'>An enduring icon that just keeps on giving, The All-New Thar comes equipped with the iconic design and all new interiors to help you Explore The Impossible</p>
                                    <div className='w-full flex justify-start gap-[25px] h-[44px] mt-[30px]'>
                                        <Buttons theme={theme} title="exquire now" outline={true} />
                                        <Buttons theme={theme} title="test drive" outline={false} />
                                    </div>
                                </div>
                            </div>
                            {/* right sides */}
                    ...
                    <div className='w-full h-full md:py-[40px] py-[20px]'>
                        ...
                        <div className='w-full md:mt-[30px] flex lg:flex-row flex-col gap-[20px] items-center py-[20px]'>
                            {/* left sides */}
                            <div className='lg:w-1/2 md:h-[300px] h-[240px] md:mt-0 mt-[10px] md:order-1 order-2'>
                                {
                                    landingImages &&
                                    <Image height={400} width={1280} src={landingImages} alt="banner-img" className='w-full h-full object-contain' />
                                }
